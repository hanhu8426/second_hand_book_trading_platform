...
<!--                            &lt;!&ndash;              <el-menu-item index="/admin/rolesList">角色列表</el-menu-item>&ndash;&gt;-->
<!--                            &lt;!&ndash;              <el-menu-item index="/admin/menuList">菜单列表</el-menu-item>&ndash;&gt;-->
<!--                        </el-menu-item-group>-->
<!--                    </el-submenu>-->
<!--                </el-menu>-->
<!--            </el-aside>-->
...
<!--                <el-main>-->
<!--                    <div style="width: 100%">-->
<!--                        &lt;!&ndash;            <a href="#/admin/info">用户信息</a> <a href="#/admin/update">修改信息</a>&ndash;&gt;-->
